...
void GameManager::Chapter2(std::vector<GameScene>& script) {
	...
	{
		if (choice == 1) {
			addScene(branch, "", "1번 선택지", "침식도 10 이하", "1번 선택지");
		}
		else if (choice == 2) {
			addScene(branch, "", "2번 선택지", "침식도 10 이하", "2번 선택지");
		}
	}
	else if (erosion > 10.0f)
	{
		if (choice == 1) {
			addScene(branch, "", "1번 선택지", "침식도 10 초과", "1번 선택지");
		}
		else if (choice == 2) {
			addScene(branch, "", "2번 선택지", "침식도 10 초과", "2번 선택지");
		}
	}
...
void GameManager::Chapter3(std::vector<GameScene>& script) {
	...
	if (choice == 1) {
		switch (sync) {
		case 0: 
			addScene(branch, "", "1번 선택지", "침식도 20 이하", ""); 
			addScene(branch, "", "test", "test", "");
			break;
		default: 
			addScene(branch, "", "1번 선택지", "침식도 20 초과", ""); 
			break;
		}
	}
	else if (choice == 2) {
		switch (sync) {
		case 0: 
			addScene(branch, "", "2번 선택지", "침식도 20 이하", ""); 
			break;
		default: 
			addScene(branch, "", "2번 선택지", "침식도 20 초과", ""); 
			break;
		}
	}
...
void GameManager::Chapter5(std::vector<GameScene>& script) {
	...
	if (choice == 1) {
		...
		case 0:
			...
			break;
		case 1:
			addScene(branch, "", "1번 선택지", "침식도 20~40", "");
			break;
		default:
			addScene(branch, "", "1번 선택지", "침식도 40 초과", "");
			break;
		}
	}
	else if (choice == 2) {
		...
		case 0:
			...
			break;
		case 1:
			addScene(branch, "", "2번 선택지", "침식도 20~40", "");
			break;
		default:
			addScene(branch, "", "2번 선택지", "침식도 40 초과", "");
			break;
		}
	}
...
void GameManager::Chapter7(std::vector<GameScene>& script) {
	...
	if (choice == 1) {
		...
		case 1:
			...
			break;
		case 2:
			addScene(branch, "", "1번 선택지", "침식도 40~60", "");
			break;
		default:
			addScene(branch, "", "1번 선택지", "침식도 60 초과", "");
			break;
		}
	}
	else if (choice == 2) {
		...
		case 1:
			...
			break;
		case 2:
			addScene(branch, "", "2번 선택지", "침식도 40~60", "");
			break;
		default:
			addScene(branch, "", "2번 선택지", "침식도 60 초과", "");
			break;
		}
	}
...
void GameManager::Chapter9(std::vector<GameScene>& script) {
	...
	if (choice == 1) {
		...
		case 2:
			...
			break;
		case 3:
			addScene(branch, "", "1번 선택지", "침식도 60~80", "");
			break;
		default:
			addScene(branch, "", "1번 선택지", "침식도 80 초과", "");
			break;
		}
	}
	else if (choice == 2) {
		...
		case 2:
			...
			break;
		case 3:
			addScene(branch, "", "2번 선택지", "침식도 60~80", "");
			break;
		default:
			addScene(branch, "", "2번 선택지", "침식도 80 초과", "");
			break;
		}
	}
